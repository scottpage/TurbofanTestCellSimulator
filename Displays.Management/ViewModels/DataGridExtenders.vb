...
Public Class DataGridExtenders
    ...
    Public Shared ReadOnly AutoScrollToEndProperty As DependencyProperty = DependencyProperty.RegisterAttached("AutoScrollToEnd", GetType(Boolean), GetType(DataGridExtenders), New UIPropertyMetadata(False, AddressOf OnAutoScrollToEndChanged))
    ...
    Public Shared Sub OnAutoScrollToEndChanged(d As DependencyObject, args As DependencyPropertyChangedEventArgs)
        ...
        Dim listBoxItems = DataGrid.Items
        ...
        Dim ScrollToEndHandler As New NotifyCollectionChangedEventHandler(Sub(s, e)
                                                                              If DataGrid.Items.Count > 0 Then
                                                                                  Dim LastItem = DataGrid.Items(DataGrid.Items.Count - 1)
